...
modify the contents of the `src/auric/lib/` and `examples/` directories.
...
You can release to package managers by using [the `Publish PyPI` GitHub action](https://www.github.com/PhoenixVazquez-glitch/opencode/actions/workflows/publish-pypi.yml). This requires a setup organization or repository secret to be set up.
