...
from ._exceptions import AuricError, APIStatusError
...
__all__ = ["Timeout", "Transport", "ProxiesTypes", "RequestOptions", "Auric", "AsyncAuric", "Client", "AsyncClient"]


class Auric(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous Auric client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("AURIC_BASE_URL")
        if base_url is None:
            base_url = f"https://petstore3.swagger.io/api/v3"

        custom_headers_env = os.environ.get("AURIC_CUSTOM_HEADERS")
    ...
    @cached_property
    def with_raw_response(self) -> AuricWithRawResponse:
        return AuricWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AuricWithStreamedResponse:
        return AuricWithStreamedResponse(self)
...
class AsyncAuric(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncAuric client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncAuricWithRawResponse:
        return AsyncAuricWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncAuricWithStreamedResponse:
        return AsyncAuricWithStreamedResponse(self)
...
class AuricWithRawResponse:
    _client: Auric

    def __init__(self, client: Auric) -> None:
        self._client = client
...
class AsyncAuricWithRawResponse:
    _client: AsyncAuric

    def __init__(self, client: AsyncAuric) -> None:
        self._client = client
...
class AuricWithStreamedResponse:
    _client: Auric
...
class AsyncAuricWithStreamedResponse:
    _client: AsyncAuric
