...
class PetsResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> PetsResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/PhoenixVazquez-glitch/opencode#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> PetsResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/PhoenixVazquez-glitch/opencode#with_streaming_response
        """
