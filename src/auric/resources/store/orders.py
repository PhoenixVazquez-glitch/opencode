...
class OrdersResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> OrdersResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/auric-python#accessing-raw-response-data-eg-headers
        """
    ...
    def with_streaming_response(self) -> OrdersResourceWithStreamingResponse:
        ...
        For more information, see https://www.github.com/stainless-sdks/auric-python#with_streaming_response
        """
